...
CREATE OR REPLACE SEMANTIC VIEW PEDIATRIC_HOSPITAL_AI_DEMO.CLINICAL_SCHEMA.CLINICAL_ANALYTICS_VIEW
    tables (
        ENCOUNTERS AS PATIENT_ENCOUNTER_FACT,
        PATIENTS AS PATIENT_DIM,
        PROVIDERS AS PROVIDER_DIM,
        DEPARTMENTS AS DEPARTMENT_DIM,
        DIAGNOSES AS DIAGNOSIS_DIM,
        CLINICAL_MEASURES AS CLINICAL_MEASURES_FACT,
        MEDICATIONS AS MEDICATION_FACT
    )
    relationships (
...
CREATE OR REPLACE SEMANTIC VIEW PEDIATRIC_HOSPITAL_AI_DEMO.CLINICAL_SCHEMA.OPERATIONAL_ANALYTICS_VIEW
    tables (
        OPERATIONS AS OPERATIONAL_FACT,
        DEPARTMENTS AS DEPARTMENT_DIM,
        QUALITY_METRICS AS QUALITY_METRICS_FACT
    )
    relationships (
...
CREATE OR REPLACE SEMANTIC VIEW PEDIATRIC_HOSPITAL_AI_DEMO.CLINICAL_SCHEMA.RESEARCH_ANALYTICS_VIEW
    tables (
        RESEARCH_OUTCOMES AS RESEARCH_OUTCOMES_FACT,
        STUDIES AS RESEARCH_STUDY_DIM,
        PATIENTS AS PATIENT_DIM,
        PROVIDERS AS PROVIDER_DIM
    )
    relationships (
...
CREATE OR REPLACE SEMANTIC VIEW PEDIATRIC_HOSPITAL_AI_DEMO.CLINICAL_SCHEMA.FINANCIAL_ANALYTICS_VIEW
    tables (
        FINANCIAL_TRANSACTIONS AS FINANCIAL_FACT,
        ENCOUNTERS AS PATIENT_ENCOUNTER_FACT,
        PATIENTS AS PATIENT_DIM,
        PAYERS AS PAYER_DIM,
        DEPARTMENTS AS DEPARTMENT_DIM
