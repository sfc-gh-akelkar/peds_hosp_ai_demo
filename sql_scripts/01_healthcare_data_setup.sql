...
-- Insert sample patient encounters (including PICU stays)
INSERT INTO patient_encounter_fact VALUES
(1, 'ENC001', 1, 1, 1, '2024-01-15', 'Inpatient', '2024-01-15', '2024-01-20', 5, 15000.00, 1, FALSE),
(2, 'ENC002', 2, 2, 3, '2024-01-18', 'Emergency', '2024-01-18', '2024-01-18', 0, 2500.00, 6, FALSE),
(3, 'ENC003', 3, 3, 4, '2024-01-20', 'Outpatient', '2024-01-20', '2024-01-20', 0, 800.00, 5, FALSE),
(4, 'ENC004', 4, 1, 1, '2024-01-22', 'Inpatient', '2024-01-22', '2024-01-28', 6, 18000.00, 2, FALSE),
(5, 'ENC005', 5, 4, 5, '2024-01-25', 'Inpatient', '2024-01-25', '2024-02-08', 14, 45000.00, 7, FALSE),
(6, 'ENC006', 6, 5, 6, '2024-01-28', 'Outpatient', '2024-01-28', '2024-01-28', 0, 350.00, 1, FALSE),
(7, 'ENC007', 7, 1, 1, '2024-02-01', 'Inpatient', '2024-02-01', '2024-02-04', 3, 12000.00, 1, FALSE),
(8, 'ENC008', 8, 6, 7, '2024-02-03', 'Inpatient', '2024-02-03', '2024-02-05', 2, 25000.00, 5, FALSE),
(9, 'ENC009', 9, 8, 2, '2024-02-05', 'Inpatient', '2024-02-05', '2024-02-25', 20, 55000.00, 8, FALSE),
(10, 'ENC010', 10, 9, 6, '2024-02-08', 'Outpatient', '2024-02-08', '2024-02-08', 0, 450.00, 4, FALSE),
(11, 'ENC011', 1, 1, 1, '2024-02-15', 'Inpatient', '2024-02-15', '2024-02-19', 4, 14500.00, 1, TRUE),
(12, 'ENC012', 3, 2, 3, '2024-02-18', 'Emergency', '2024-02-18', '2024-02-19', 1, 3200.00, 6, FALSE),
(13, 'ENC013', 5, 1, 1, '2024-02-20', 'Inpatient', '2024-02-20', '2024-02-27', 7, 19500.00, 7, FALSE),
(14, 'ENC014', 7, 4, 5, '2024-02-22', 'Inpatient', '2024-02-22', '2024-03-10', 16, 48000.00, 7, FALSE),
(15, 'ENC015', 2, 2, 3, '2024-02-25', 'Emergency', '2024-02-25', '2024-02-25', 0, 1800.00, 6, FALSE);

-- Insert sample clinical measures
INSERT INTO clinical_measures_fact VALUES
(1, 1, 1, 1, '2024-01-15 08:00:00', 'Vital Signs', 'Heart Rate', 95.0, 'bpm', 80.0, 120.0, FALSE),
(2, 1, 1, 1, '2024-01-15 08:00:00', 'Vital Signs', 'Temperature', 98.6, 'F', 97.0, 99.5, FALSE),
(3, 2, 2, 2, '2024-01-18 14:30:00', 'Lab Results', 'White Blood Count', 12500.0, 'cells/uL', 4000.0, 11000.0, TRUE),
(4, 3, 3, 3, '2024-01-20 10:15:00', 'Vital Signs', 'Blood Pressure Systolic', 110.0, 'mmHg', 90.0, 120.0, FALSE),
(5, 4, 4, 1, '2024-01-22 06:45:00', 'Vital Signs', 'Oxygen Saturation', 92.0, '%', 95.0, 100.0, TRUE),
(6, 5, 5, 4, '2024-01-25 12:20:00', 'Lab Results', 'Hemoglobin', 8.2, 'g/dL', 11.0, 16.0, TRUE),
(7, 6, 6, 5, '2024-01-28 09:30:00', 'Vital Signs', 'Heart Rate', 88.0, 'bpm', 70.0, 110.0, FALSE),
(8, 7, 7, 1, '2024-02-01 16:45:00', 'Vital Signs', 'Temperature', 101.2, 'F', 97.0, 99.5, TRUE),
(9, 8, 8, 6, '2024-02-03 11:00:00', 'Lab Results', 'Glucose', 180.0, 'mg/dL', 70.0, 140.0, TRUE),
(10, 9, 9, 8, '2024-02-05 07:15:00', 'Vital Signs', 'Respiratory Rate', 28.0, 'breaths/min', 12.0, 25.0, TRUE);

-- Insert sample medication administration
INSERT INTO medication_fact VALUES
(1, 1, 1, 1, 1, '2024-01-15 10:00:00', 2.5, 'mg', 'Inhalation', 'Every 4 hours'),
(2, 2, 2, 3, 2, '2024-01-18 15:00:00', 150.0, 'mg', 'Oral', 'Twice daily'),
(3, 4, 4, 1, 1, '2024-01-22 08:00:00', 2.5, 'mg', 'Inhalation', 'Every 6 hours'),
(4, 5, 5, 5, 4, '2024-01-25 14:30:00', 1.5, 'mg/m2', 'IV', 'Weekly'),
(5, 7, 7, 1, 1, '2024-02-01 18:00:00', 2.5, 'mg', 'Inhalation', 'Every 4 hours'),
(6, 8, 8, 9, 6, '2024-02-03 12:00:00', 0.125, 'mg', 'Oral', 'Daily'),
(7, 9, 9, 10, 8, '2024-02-05 09:00:00', 1.0, 'g', 'IV', 'Twice daily'),
(8, 1, 11, 8, 1, '2024-02-15 11:30:00', 160.0, 'mg', 'Oral', 'Every 6 hours'),
(9, 5, 13, 5, 1, '2024-02-20 16:45:00', 2.5, 'mg', 'Inhalation', 'Every 4 hours'),
(10, 7, 14, 5, 4, '2024-02-22 13:20:00', 1.5, 'mg/m2', 'IV', 'Weekly');

-- Insert sample financial transactions
INSERT INTO financial_fact VALUES
(1, 1, 1, 2, 1, '2024-01-20', '2024-01-15', 15000.00, 12000.00, 500.00, 'Charge'),
(2, 2, 2, 1, 3, '2024-01-18', '2024-01-18', 2500.00, 2000.00, 100.00, 'Charge'),
(3, 3, 3, 2, 4, '2024-01-20', '2024-01-20', 800.00, 640.00, 40.00, 'Charge'),
(4, 4, 4, 1, 1, '2024-01-28', '2024-01-22', 18000.00, 14400.00, 600.00, 'Charge'),
(5, 5, 5, 5, 5, '2024-02-08', '2024-01-25', 45000.00, 36000.00, 1500.00, 'Charge'),
(6, 6, 6, 2, 6, '2024-01-28', '2024-01-28', 350.00, 280.00, 20.00, 'Charge'),
(7, 7, 7, 2, 1, '2024-02-04', '2024-02-01', 12000.00, 9600.00, 400.00, 'Charge'),
(8, 8, 8, 5, 7, '2024-02-05', '2024-02-03', 25000.00, 20000.00, 800.00, 'Charge'),
(9, 9, 9, 1, 2, '2024-02-25', '2024-02-05', 55000.00, 44000.00, 2000.00, 'Charge'),
(10, 10, 10, 2, 6, '2024-02-08', '2024-02-08', 450.00, 360.00, 25.00, 'Charge');
